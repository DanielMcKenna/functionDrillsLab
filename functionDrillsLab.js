...
function add(num1, num2) {
  let num1Conversion = +num1;
  let num2Convesion = +num2;

  return num1Conversion + num2Convesion;
}
...
let testarray = theEliminator(contestants, loser);
...
function emailCheck(email) {
  let emailToString = String(email).trim("");

  if (emailToString.includes("@")) {
